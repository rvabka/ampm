...
import { Truck, Bus, Package, Boxes, Snowflake, Globe, ArrowLeft, ArrowRight, type LucideIcon } from "lucide-react";
import "swiper/css";
...
const services: Service[] = [
  {
    ...
    description:
      "Realizujemy przewozy na terenie całej Unii Europejskiej. Pełna kontrola, stały monitoring i dedykowany spedytor od załadunku do rozładunku.",
  ...
  },
  {
    ...
    description:
      "Obsługujemy zlecenia na terenie całej Polski. Terminowe dostawy, elastyczne podejście i stały kontakt z klientem.",
  ...
  },
  {
    ...
    description:
      "Busy do 3,5 t dla przesyłek wymagających pilnego dostarczenia. Szybka reakcja i elastyczne terminy odbioru.",
  ...
  },
  {
    ...
    description:
      "Przewóz towarów wymagających kontrolowanej temperatury. Chłodnie dostosowane do specyfiki ładunku.",
