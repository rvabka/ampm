    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 px-6 py-5 border-t border-gray-100 flex items-center justify-between">
          <p className="text-secondary/40 text-xs tracking-wider uppercase">
            Obserwuj nas
          </p>
          <div className="flex items-center gap-2">
            <a
              ...
              aria-label="Facebook"
              className="p-2 rounded-lg text-secondary/40 hover:text-primary hover:bg-primary/8 transition"
            >
              <FacebookIcon />
            </a>
            <a
